...
if (fs.existsSync(filePath)) {
    ...
    axios.post(url,memorymessages, config)
        ...
        .catch(error => {
        // 當請求失敗時，打印以下信息到控制台顯示錯誤訊息
        console.error('error DiskSpace.json 檔案不見須注意:', error.response.data);
        // 在Summerlog文件中追加寫入'訊息發送失敗'，如果出現錯誤則在控制台打印錯誤信息
